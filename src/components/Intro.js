			...
			<div className='section-container'>
				<div className='intro'>
					...
					<div className='description'>
						<p>
							As a former electrical engineer turned fullstack developer, I love
							crafting simple solutions to interesting problems. Machine
							learning, responsive design, and physics-based animation libraries
